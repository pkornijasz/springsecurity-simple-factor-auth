...
public class UserService {
    ...
    private void sendToken(AppUser appUser) {
        ...
        String url = "To tylko test aplikacji logującej, kliknij proszę: http://localhost:8080/token?value=" + tokenValue;

        try {
            mailService.sendMail(appUser.getUsername(), "Potwierdź to", url, false);
